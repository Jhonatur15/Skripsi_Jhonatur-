void fuzzyRule() {
  ...
  KOLAM_1->addOutput(VAL);
  KOLAM_1->addOutput(ON);
  // =====
  ...
  KOLAM_2->addOutput(VAL);
  KOLAM_2->addOutput(ON);
  // =====
  ...
  KOLAM_3->addOutput(VAL);
  KOLAM_3->addOutput(ON);
  // =====
  ...
  KOLAM_4->addOutput(VAL);
  KOLAM_4->addOutput(OFF);
  // =====
  ...
  KOLAM_5->addOutput(VAL);
  KOLAM_5->addOutput(OFF);
  // =====
  ...
  KOLAM_6->addOutput(VAL);
  KOLAM_6->addOutput(OFF);
  // =====
  ...
  KOLAM_7->addOutput(POM);
  KOLAM_7->addOutput(ON);
  // =====
  ...
  KOLAM_8->addOutput(POM);
  KOLAM_8->addOutput(ON);
  // =====
  ...
  KOLAM_9->addOutput(VAL);
  KOLAM_9->addOutput(ON);
  // =====
  ...
  KOLAM_10->addOutput(POM);
  KOLAM_10->addOutput(OFF);
  // =====
  ...
  KOLAM_11->addOutput(POM);
  KOLAM_11->addOutput(OFF);
  // =====
  ...
  KOLAM_12->addOutput(VAL);
  KOLAM_12->addOutput(OFF);
  // =====
  ...
  KOLAM_13->addOutput(POM);
  KOLAM_13->addOutput(OFF);
  // =====
  ...
  KOLAM_14->addOutput(POM);
  KOLAM_14->addOutput(OFF);
  // =====
  ...
  KOLAM_15->addOutput(VAL);
  KOLAM_15->addOutput(OFF);
  // =====
  ...
  KOLAM_16->addOutput(VAL);
  KOLAM_16->addOutput(ON);
  // =====
  ...
  KOLAM_17->addOutput(VAL);
  KOLAM_17->addOutput(ON);
  // =====
  ...
  KOLAM_18->addOutput(VAL);
  KOLAM_18->addOutput(ON);
  // =====
  ...
  KOLAM19->addOutput(VAL);
  KOLAM19->addOutput(OFF);
  // =====
  ...
  KOLAM_20->addOutput(VAL);
  KOLAM_20->addOutput(OFF);
  // =====
  ...
  KOLAM_21->addOutput(VAL);
  KOLAM_21->addOutput(OFF);
  // =====
  ...
  // Build FuzzyRule26 (Saturation= Medium(MS), E_Do= Zero(LD))
